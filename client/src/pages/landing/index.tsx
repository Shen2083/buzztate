    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-yellow-400 selection:text-black">
      ...
      <div className="max-w-4xl mx-auto text-center mt-20 px-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          ...
          <Link href="/app?plan=pro">
            <span className="px-8 py-4 rounded-xl bg-yellow-400 hover:bg-yellow-300 text-black font-bold cursor-pointer transition-all shadow-[0_0_20px_rgba(250,204,21,0.3)]">
              Get Pro Access - $10/mo
            </span>
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 mt-32 mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-8 rounded-3xl border border-yellow-400 bg-gray-900/20 relative flex flex-col">
            ...
            <Link href="/app?plan=pro">
              <span className="w-full block text-center py-4 rounded-xl bg-yellow-400 hover:bg-yellow-300 text-black font-bold cursor-pointer transition-all shadow-lg">
                Upgrade to Pro
              </span>
            </Link>
          </div>
